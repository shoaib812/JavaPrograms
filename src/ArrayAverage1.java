...
//    }
    ...
    public void compareArrays(int arr[], int arr1[], int arr2[], int arr3[]) {
        if (arr == arr1) {
            System.out.println("arr & arr1 are same");
        } else {
            System.out.println("arr & arr1 are not same");
        }

        if (arr == arr2) {
            System.out.println("arr & arr2 are same");
        } else {
            System.out.println("arr & arr2 are not same");
        }

        if (arr == arr3) {
            System.out.println("arr & arr3 are same");
        } else {
            System.out.println("arr & arr3 are not same");
        }
